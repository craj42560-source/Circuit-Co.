...
// Reads, filters, and manages bookings saved to localStorage.
...
function renderBookings() {
  ...
  if (bookings.length === 0) {
    $container.html(
      '<div class="glass-strong p-5 text-center mx-auto animate-scale-in" style="max-width: 600px;">' +
        ...
        '<p style="color: var(--slate-500);" class="mb-4">When you book a repair, it will appear here. Your bookings are saved on this device using your browser\'s local storage.</p>' +
  ...
  var html = filtered.map(function (b) {
    ...
    var urgencyHtml = (urgencyOption && urgencyOption.id !== 'standard') ? '<span class="badge bg-primary-100" style="color: var(--primary-600); font-size: 0.7rem;">' + urgencyOption.label.split(' (')[0] + '</span>' : '';
